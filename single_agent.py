...
def main():
    ...
    agent = Agent(id =0,
                    ...
                    device=device,
                    checkpoint_folder=hyperparameters['checkpoint_folder']+'/agent_single_agent.pt') 
    ...
    for episode in range(episodes):
        ...
        while not done:
            ...
            for i in range(number_of_servers):
                ...
                actions[i] = agent.choose_action(local_observations[i],lstm_input)
            ...
            for i in range(number_of_servers):
                ...
                agent.store_transitions(state = local_observations[i],
